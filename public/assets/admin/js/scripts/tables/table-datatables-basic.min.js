$(function () {
        ...
        o = "../../../app-assets/";
    {
        var n = e.DataTable({
            ...
            order: [[2, "desc"]],
            dom: '<"card-header border-bottom p-1"><"dt-action-buttons text-end"><"d-flex justify-content-between align-items-center mx-0 row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f>>t<"d-flex justify-content-between mx-0 row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
            displayLength: 7,
