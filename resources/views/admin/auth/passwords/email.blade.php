...
<div class="card mb-0">
    <div class="card-body">
      ...
      <form class="auth-forgot-password-form mt-2" action="https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/html/ltr/vertical-menu-template-bordered/auth-reset-password-basic.html" method="POST">
        <div class="mb-1">
