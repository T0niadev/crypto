          ...
          <div class="card">
            <div class="tabs flex flex-col">
              ...
              <div class="tab-content p-4 sm:p-5">
                ...
                <label for="number" class="block mt-3">
                  <span class="font-medium text-slate-600 dark:text-navy-100">Account Name or Wallet ID</span>
                ...
                <label for="number" class="block mt-3">
                  <span class="font-medium text-slate-600 dark:text-navy-100">Account Number or Wallet</span>
