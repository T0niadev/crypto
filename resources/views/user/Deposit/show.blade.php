  ...
  <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="relative bg-white rounded-lg ">
          ...
          <div class="p-6 pt-0 text-center">
            ...
            <div class="relative mt-4">
              <img class="h-full w-full rounded-lg object-cover object-center" src="{{ asset('assets/images/g.png') }}"
                alt="wallet" />
    ...
    <div class="mt-4 sm:mt-5 lg:mt-6">
      <div class="flex items-center justify-between">
        <h3 class="text-base font-medium tracking-wide text-slate-700 line-clamp-1 dark:text-navy-100 mb-4">
            ...
            <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
              ...
              <td>
                <div class="flex items-center space-x-2">
                  ...
                  <button
                    class="btn min-w-[4rem] bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90"
