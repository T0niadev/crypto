...
@section('content')
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <form class="payment-form" method="POST" role="form" action="{!! URL::route('coinbase.paybtcamt') !!}" >
          @csrf
                            ...
                            <div class="tab-content p-4 sm:p-5">
                                    ...
                                    <label for="amount" class="block">
                                        ...
                                        <input
                                           ...
                                           type="text" name="amount" placeholder="Ensure you enter the same amount in the deposit form">
