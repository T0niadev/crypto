...
@section('content')
                ...
                <span class="a3x aa a32 a33 ac a1t a1u a1">
                  <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                    ...
                    <g clip-path="url(#clip0_73_10312)">
                      <path d="M13.9982 6.12451L13.8926 6.48343V16.8976L13.9982 17.003L18.8323 14.1456L13.9982 6.12451Z"
                        fill="#D6D6D6" />
                      <path d="M13.9982 6.12451L9.16406 14.1456L13.9982 17.003V11.9483V6.12451Z" fill="white" />
                      <path d="M13.998 17.9175L13.9385 17.9901V21.6998L13.998 21.8736L18.835 15.0615L13.998 17.9175Z"
                        fill="#D6D6D6" />
        ...
        <div class="ag aa a1L ac">
          ...
          <div class="ab ak lg:a1M/2">
            <div class="wow fadeInUp a3S" data-wow-delay="0s">
              <span class="a2d aO a1P a3L aR sm:a1O"> TOKEN </span>
              <h2 class="a2d a2o a1P a2p a1k dark:aT md:a2Q[45px]">Token Sale</h2>
              <p class="aO a1R aQ dark:aS">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus condimentum
                tellus at lectus pulvinar, id auctor felis iaculis. In vestibulum neque sem, at
            ...
            <div class="wow fadeInUp a3T" data-wow-delay="0s">
              <p class="aa">
                ...
                <span class="aO a1R aQ dark:aS"> 73% Financial Overhead </span>
              </p>
              <p class="aa">
                <span class="a1p a3U a3V a1u a1w[#2347B9]"></span>
                <span class="aO a1R aQ dark:aS"> 55% Bonus & found </span>
              </p>
              <p class="aa">
                <span class="a1p a3U a3V a1u a1w[#8BA6FF]"></span>
                <span class="aO a1R aQ dark:aS"> 38% it infastrueture </span>
              </p>
              <p class="aa">
                <span class="a1p a3U a3V a1u a1w[#8696CA]"></span>
                <span class="aO a1R aQ dark:aS"> 20.93% Gift Code Inventory </span>
              </p>
            </div>
          </div>
        </div>
  ...
  {{-- <section id="roadmap" class="af a2E aw[120px]">
    <div class="ae">
      <div class="wow fadeInUp a3r a3K aH[590px] a2G md:a30" data-wow-delay="0s">
        ...
        <h2 class="a2d a2o a1P a2p a1k dark:aT md:a2Q[45px]">The Timeline</h2>
        <p class="aO a1R aQ dark:aS">
          ...
          <div class="wow fadeInUp af ag aa a1L md:a3X lg:a3Y" data-wow-delay="0s">
            ...
            <div class="ab ak md:a1M/2">
              <div class="af a2E a1W au a1v a3_ aI dark:a3 md:a2k md:a1Q md:a2L lg:a20">
                ...
                <h3 class="a2d a1O a1P a1k dark:aT">Feb 25,2020</h3>
                <p class="a2K a1F a1R aQ dark:aS">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc sed congue arcu,
                  In et dignissim quam condimentum vel
                </p>
                <a href="#" class="aV ac a1t a1u a1 a45 a46">
                  ...
                  <span class="a2t a2g aP aQ dark:aS"> Bitcoin </span>
                  <span class="a2Q[8px] aP aQ dark:a2Q[#959595]"> 4.5% </span>
                  <span>
            ...
            <div class="ab ak md:a1M/2">
              <div class="af a2E a1W au a1v a3_ aI dark:a3 md:a2O md:a1Q lg:a47">
                ...
                <h3 class="a2d a1O a1P a1k dark:aT">Jan 14,2021</h3>
                <p class="a2K a1F a1R aQ dark:aS">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc sed congue arcu,
                  In et dignissim quam condimentum vel
                </p>
                <a href="#" class="aV ac a1t a1u a1 a45 a46">
                  ...
                  <span class="a2t a2g aP aQ dark:aS"> ethereum </span>
                  <span class="a2Q[8px] aP aQ dark:a2Q[#959595]"> 2.5% </span>
                  <span>
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                      xmlns="http://www.w3.org/2000/svg">
                      <path
            ...
            <div class="ab ak md:a1M/2">
              <div class="af a2E a1W au a1v a3_ aI dark:a3 md:a2k md:a1Q md:a2L lg:a20">
                <span class="aq as/2 a1a ao a40 a1U at/2 a1u a41 a1H a1 dark:a27 md:a3b md:a42 md:an lg:a43"></span>
                <span class="aq a44 as/2 ao a3e a3f at/2 az a1v dark:a3 md:an"></span>
                <h3 class="a2d a1O a1P a1k dark:aT">Mar 30,2021</h3>
                <p class="a2K a1F a1R aQ dark:aS">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc sed congue arcu,
                  In et dignissim quam condimentum vel
                </p>
                <a href="#" class="aV ac a1t a1u a1 a45 a46">
                  ...
                  <span class="a2t a2g aP aQ dark:aS"> chainlink </span>
                  <span class="a2Q[8px] aP aQ dark:a2Q[#959595]"> 4.5% </span>
                  <span>
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                      xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="ab ak md:a1M/2">
              <div class="af a2E a1W au a1v a3_ aI dark:a3 md:a2O md:a1Q lg:a47">
                <span class="aq as/2 a1a ao a40 a1U at/2 a1u a41 a1H a1 dark:a27 md:a48 md:a49 md:an lg:a4a"></span>
                <span class="aq a4b as/2 ao a3e a3f at/2 az a1v dark:a3 md:an"></span>
                <h3 class="a2d a1O a1P a1k dark:aT">Dec 19,2021</h3>
                <p class="a2K a1F a1R aQ dark:aS">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc sed congue arcu,
                  In et dignissim quam condimentum vel
                </p>
                <a href="#" class="aV ac a1t a1u a1 a45 a46">
                  ...
                  <span class="a2t a2g aP aQ dark:aS"> polygon </span>
                  <span class="a2Q[8px] aP aQ dark:a2Q[#959595]"> 2.5% </span>
                  <span>
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                      xmlns="http://www.w3.org/2000/svg">
  ...
  {{-- <section id="team" class="a36 a2l[#F3F4F4] a1J[120px] a1T dark:a2l[#2D2C4A]">
    <div class="ae">
      <div class="wow fadeInUp a3r a3K aH[590px] a2G md:a30" data-wow-delay="0s">
        ...
        <h2 class="a2d a2o a1P a2p a1k dark:aT md:a2Q[45px]">Meet out Team</h2>
        <p class="aO a1R aQ dark:aS">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc sed congue arcu, In et
          dignissim quam condimentum vel.
        </p>
      ...
      <div class="ag aa a1L">
        <div class="ab ak sm:a1M/2 lg:a1M/4">
          <div class="aZ wow fadeInUp a1W au a4c a21 a1v a1f a2G a1G hover:a1H dark:a3" data-wow-delay="0s">
            <div class="a2a a2c a1i">
              <img src="{{ asset('assets/images/team/image-01.jpg') }}" alt="team" class="a4d ab" />
            </div>
            <div>
              <h3 class="a2s aO aP a1k dark:aT">Matheus Ferrero</h3>
              <p class="a2d a1j a1R aQ dark:aS">Marketing Expert</p>
              <div class="a1N aa ac a1t a4e">
                <a href="javascript:void(0)" class="a2Q[#B6BFC9] hover:aR dark:aT dark:hover:aR" name="social-link"
        ...
        <div class="ab ak sm:a1M/2 lg:a1M/4">
          <div class="aZ wow fadeInUp a1W au a4c a21 a1v a1f a2G a1G hover:a1H dark:a3" data-wow-delay="0s">
            <div class="a2a a2c a1i">
              <img src="{{ asset('assets/images/team/image-02.jpg') }}" alt="team" class="a4d ab" />
            </div>
            <div>
              <h3 class="a2s aO aP a1k dark:aT">Eva Hudson</h3>
              <p class="a2d a1j a1R aQ dark:aS">Blockchain Developer</p>
              <div class="a1N aa ac a1t a4e">
                <a href="javascript:void(0)" class="a2Q[#B6BFC9] hover:aR dark:aT dark:hover:aR" name="social-link"
                  aria-label="social-link">
                  <svg width="20" height="20" viewBox="0 0 20 20" class="a1B">
        ...
        <div class="ab ak sm:a1M/2 lg:a1M/4">
          <div class="aZ wow fadeInUp a1W au a4c a21 a1v a1f a2G a1G hover:a1H dark:a3" data-wow-delay="0s">
            <div class="a2a a2c a1i">
              <img src="{{ asset('assets/images/team/image-03.jpg') }}" alt="team" class="a4d ab" />
            </div>
            <div>
              <h3 class="a2s aO aP a1k dark:aT">Jackie Sanders</h3>
              <p class="a2d a1j a1R aQ dark:aS">Creative Designer</p>
              <div class="a1N aa ac a1t a4e">
                <a href="javascript:void(0)" class="a2Q[#B6BFC9] hover:aR dark:aT dark:hover:aR" name="social-link"
                  aria-label="social-link">
                  <svg width="20" height="20" viewBox="0 0 20 20" class="a1B">
        ...
        <div class="ab ak sm:a1M/2 lg:a1M/4">
          <div class="aZ wow fadeInUp a1W au a4c a21 a1v a1f a2G a1G hover:a1H dark:a3" data-wow-delay="0s">
            <div class="a2a a2c a1i">
              <img src="{{ asset('assets/images/team/image-04.jpg') }}" alt="team" class="a4d ab" />
            </div>
            <div>
              <h3 class="a2s aO aP a1k dark:aT">Jackie Sanders</h3>
              <p class="a2d a1j a1R aQ dark:aS">SEO Expert</p>
              <div class="a1N aa ac a1t a4e">
                <a href="javascript:void(0)" class="a2Q[#B6BFC9] hover:aR dark:aT dark:hover:aR" name="social-link"
                  aria-label="social-link">
                  <svg width="20" height="20" viewBox="0 0 20 20" class="a1B">
      ...
      <div class="ag aa a1L ac">
        ...
        <div class="ab ak lg:a1M/2">
          <div class="wow fadeInUp af -a2E a2G" data-wow-delay="0s">
            <img src="{{ asset('assets/images/download/app-image.png') }}" alt="app image"
              class="a3r ao dark:an a2G" />
            <img src="{{ asset('assets/images/download/app-image-2.png') }}" alt="app image" class="a3r dark:ao" />
            <span class="aq a19 a2J aD[320px] aC[320px] a1u a2Z"
              style="
  ...
  <section id="faq" x-data="{
    ...
    <div class="aq a19 a4t a2Z">
      <img src="{{ asset('assets/images/shapes/faq-shape-2.svg') }}" alt="shape" />
    </div>
  </section>
  ...
  {{-- <section id="blog" class="a1J[120px] a1T">
    <div class="ae">
      <div class="wow fadeInUp a3r a3K aH[590px] a2G md:a30" data-wow-delay="0s">
        ...
        <h2 class="a2d a2o a1P a2p a1k dark:aT md:a2Q[45px]">Recent News & Blogs</h2>
        <p class="aO a1R aQ dark:aS">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc sed congue arcu, In et
          dignissim quam condimentum vel.
        </p>
      ...
      <div class="ag aa a1L">
        <div class="ab ak md:a1M/2 lg:a1M/3">
          <div class="wow fadeInUp a1W a2c au a1v dark:a1w[#14102C]" data-wow-delay="0s">
            <a href="blog-details.html" class="an">
              <img src="{{ asset('assets/images/blogs/image-01.jpg') }}" alt="blog-image" class="ab" />
            </a>
            <div class="a3h lg:aI xl:a29">
              <div class="a2s aa ac">
                <p class="a2k aa ac aQ dark:aS">
                  <span class="a2t a2u dark:aT">
                    <svg width="22" height="22" viewBox="0 0 22 22" class="a1B">
                      <path
              ...
              <p class="a1F a1R a4u aQ dark:aS">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc sed congue arcu, In
                et dignissim quam condime vel.
              </p>
            </div>
          </div>
        </div>
        <div class="ab ak md:a1M/2 lg:a1M/3">
          <div class="wow fadeInUp a1W a2c au a1v dark:a1w[#14102C]" data-wow-delay="0s">
            <a href="blog-details.html" class="an">
              <img src="{{ asset('assets/images/blogs/image-02.jpg') }}" alt="blog-image" class="ab" />
            </a>
            <div class="a3h lg:aI xl:a29">
              <div class="a2s aa ac">
                <p class="a2k aa ac aQ dark:aS">
        ...
        <div class="ab ak md:a1M/2 lg:a1M/3">
          <div class="wow fadeInUp a1W a2c au a1v dark:a1w[#14102C]" data-wow-delay="0s">
            <a href="blog-details.html" class="an">
              <img src="{{ asset('assets/images/blogs/image-03.jpg') }}" alt="blog-image" class="ab" />
            </a>
            <div class="a3h lg:aI xl:a29">
              <div class="a2s aa ac">
                <p class="a2k aa ac aQ dark:aS">
      ...
      <div class="ag aa a1L ac">
        ...
        <div class="ab ak lg:a4x/12">
          <div class="sm:a4y wow fadeInUp a1X a1 a3O a1E dark:a3" data-wow-delay="0s">
            ...
            <form>
              <div class="a2K">
                <label for="name" class="a2s an a1j a1R a2u dark:aT"> Full Name* </label>
                <input type="text" id="name" placeholder="Enter your full name"
                  class="ab a1X a1C a2l[#E9E9E9] a4z a22 a23 a1F a1R aS a24 focus:a1H dark:a4A dark:a1 dark:a4B" />
              </div>
              <div class="a2K">
                <label for="email" class="a2s an a1j a1R a2u dark:aT"> Email Address* </label>
                <input type="email" id="email" placeholder="Enter your email address"
                  class="ab a1X a1C a2l[#E9E9E9] a4z a22 a23 a1F a1R aS a24 focus:a1H dark:a4A dark:a1 dark:a4B" />
              </div>
              <div class="a2K">
                <label for="message" class="a2s an a1j a1R a2u dark:aT"> Message* </label>
                <textarea rows="6" id="message" placeholder="Type your message"
                  class="ab a1X a1C a2l[#E9E9E9] a4z a22 a23 a1F a1R aS a24 focus:a1H dark:a4A dark:a1 dark:a4B"></textarea>
              </div>
              <div>
    ...
    <div class="ae">
      <div class="wow fadeInUp af a2E a2c a1i a3 a29 sm:a2P" data-wow-delay="0s">
            ...
            <div>
              <form class="af">
                <input type="email" placeholder="Enter email address"
                  class="ab a1u a1C a21 a1 aW a2R a1F a1R aQ a24 dark:aS sm:a2S" />
        ...
        <div class="aq a8 a19 a2Z">
          <img src="{{ asset('assets/images/shapes/newsletter-shape.svg') }}" alt="shape" />
        </div>
      </div>
    </div>
  </section>
